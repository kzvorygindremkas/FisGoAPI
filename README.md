...
```
    ...
    Обязательность, точные наименования и формат полей педставлена в API Кабинета Дримкас.
    ...
    ["positions"]                               [Список позиций чека]
        ...
        ["name"]                    [STRING]    [Наименование предмета расчета]
        ...
        ["tags"]                                [Список тэгов ФФД (позиция)]
            ...
            [777]                   [INT]       [сумма предоплаты на позицию] - системный тег - не содержится в ФФД
        ["quantity"]                [INT]       [Количество предмета расчета]
        ["price"]                   [INT]       [Цена за еденицу расчета в копейках]
    ...
    ["payments"]                    [Список платежей (*поддерживается только один вид платежа на чек)]
        ["sum"]                     [INT]       [Оплата в копейках]
    ...
    ["attributes"]                  [Данные покупателя]
        ["phone"]                   [STRING]    [Телефонный номер. Шаблон - +\d{11}]
        ["email"]                   [STRING]    [Электронная почта. Шаблон - .+@..+]


    ["total"]                       [Итог чека]
        ["total_sum"]               [INT]       [итоговая сумма в копейках]
        ["taxes_sum"]               [STRING]    [Сумма примененных НДС в копейках, сгруппированных по типу]
            ["NDS_10"]                          [НДС 10%]
            ["NDS_18"]                          [НДС 20%]
            ["NDS_10_CALCULATED"]               [НДС Расчетная 10%]
            ["NDS_18_CALCULATED"]               [НДС Расчетная 20%]


    ["tags"]                        [Список тэгов ФФД (чек)]
        [1171]                      [STRING]    [телефон поставщика]
        [1225]                      [STRING]    [наименование поставщика]
        [1226]                      [STRING]    [ИНН поставщика]
        [1057]                      [INT]       [признак агента]
        ...
        [1215]                      [INT]       [сумма по чеку (БСО) предоплатой (зачётом аванса и (или) предыдущих платежей)]
